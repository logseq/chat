...
CAMLprim __attribute__((weak)) value logseq_chat_https_send(value method, value url, value body,
                                                            value token) {
...
CAMLprim __attribute__((weak)) value logseq_chat_https_upload_file(
    value method, value url, value file_path, value content_type, value token) {
